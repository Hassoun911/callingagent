...
// Temporary one-shot endpoint. Removed immediately after the production WhatsApp test.
...
router.use(portalVisibilityRouter);
router.use(enforceCompanyPortalVisibility);
