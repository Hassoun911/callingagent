...
export const getListCompanyAppointmentsUrl = (id: number,) => {




  return `/api/companies/${id}/appointments`
}

export const listCompanyAppointments = async (id: number, options?: RequestInit): Promise<Appointment[]> => {

  return customFetch<Appointment[]>(getListCompanyAppointmentsUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getListCompanyAppointmentsQueryKey = (id: number,) => {
    return [
    `/api/companies/${id}/appointments`
    ] as const;
    }


export const getListCompanyAppointmentsQueryOptions = <TData = Awaited<ReturnType<typeof listCompanyAppointments>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listCompanyAppointments>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListCompanyAppointmentsQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listCompanyAppointments>>> = ({ signal }) => listCompanyAppointments(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listCompanyAppointments>>, TError, TData> & { queryKey: QueryKey }
}

export type ListCompanyAppointmentsQueryResult = NonNullable<Awaited<ReturnType<typeof listCompanyAppointments>>>
export type ListCompanyAppointmentsQueryError = ErrorType<unknown>



export function useListCompanyAppointments<TData = Awaited<ReturnType<typeof listCompanyAppointments>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listCompanyAppointments>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListCompanyAppointmentsQueryOptions(id,options)
